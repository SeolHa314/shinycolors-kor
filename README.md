...
각 대사 항목의 번역 본을 text-user 항목에 넣어주세요. 이미 DB에 들어가 text-patch가 존재하는 항목은 오역이 아닌 이상 text-user를 이용해 덮어쓰는 일이 없도록 해주세요. 번역본은 되도록 한 파일에 모두 기재 된 상태로 <maxkss0829@naver.com> 으로 보내주신다면 수시로 반영하겠습니다.  
